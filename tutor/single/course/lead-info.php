			...
			<?php if ( ! $disable_course_author ) { ?>
				<li class="tutor-single-course-author-meta">
					<div class="tutor-single-course-avatar">
						<a href="<?php echo esc_url( $profile_url ); ?>"> <?php echo get_the_post_thumbnail( $instructor_id, 'tutor-single-course-avatar' ); ?></a>
					</div>
					<div class="tutor-single-course-author-name">
						<span><?php _e( 'by', 'tutor' ); ?></span>
						<a href="<?php echo esc_url( $profile_url ); ?>"><?php echo $profile_name; ?></a>
					</div>
				</li>
			<?php } ?>
